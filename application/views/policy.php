...
<div class="container">
    <div class="col-md-12">
        <div class="panel panel-primary">
            <div class="panel-heading"><strong>Admission & Refund Policy </strong></div>
            <div class="panel-body">
                <div class="row">
                  <div class="list-group">
                      <a href="#" class="list-group-item"><span><i class="fa fa-hand-o-right"></i></span> Admision Once Paid can not not be withdrawn or cancelled by the student.</a>

                    <a href="#" class="list-group-item"><span><i class="fa fa-hand-o-right"></i></span> All Admission are subjected to physical document verfication.</a>

                    <a href="#" class="list-group-item"><span><i class="fa fa-hand-o-right"></i></span> Incase, of any, any misinformation  found, at any stage of the course, the college admission & university registration shall be terminated.</a>
                  
                    <a href="#" class="list-group-item"><span><i class="fa fa-hand-o-right"></i></span> No refund of college admission fees or university registration fee is applicable on admission cancellation.</a>
