...
<head>
    ...
    <!-- Latest compiled and minified Font CDN -->
...
<body>
    <nav class="header">
        ...
        <ul class="menu">
            ...
            <li><a href="<?php echo base_url('login/account') ?>" class="btn btns btn-success p-2 my-3 mx-3">My Account</a></li>
        </ul>
    </nav>
    <br>
      ...
      <div class="container p-3">
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            <h4>Useful Links</h4>
            <ul>
              <li><a href="<?php echo base_url('dashboard/account') ?>">Home</a></li>
              <li><a href="<?php echo base_url('dashboard/plans') ?>">Plans</a></li>
              <li><a href="<?php echo base_url('dashboard/terms') ?>">Terms of service</a></li>
