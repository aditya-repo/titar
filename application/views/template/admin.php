          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_info pl-5 pt-2">
                <span>Welcome,</span>
                <h2>Admin</h2>
                <!-- <h2><?php echo $this->session->userdata('cname'); ?></h2> -->
              </div>
            </div>
            <!-- /menu profile quick info -->
            <br />
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="<?php echo base_url('admin/user_report');?>"><i class="fa fa-edit"></i>User Report</a></li>
                  <li><a href="<?php echo base_url('update_ads/index');?>"><i class="fa fa-upload"></i>Upload Ads </a></li>
                  <li><a href="<?php echo base_url('update_voucher/index');?>"><i class="fa fa-upload"></i>Vouchers</a></li>
